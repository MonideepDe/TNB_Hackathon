function koreBotChat() {
    ...
    function chatWindow(cfg) {
		...
		userSelectedLanguage = cfg.botOptions.userLang;
    ...
    chatWindow.prototype.bindEvents = function () {
        ...
        bot.on("message", function (message) {
            ...
            if (tempData.from === "bot" && tempData.type === "bot_response") {
				...
				var targetLang = userSelectedLanguage;
				if(tempData.message[0] && tempData.message[0].cInfo && tempData.message[0].cInfo.body) {
					translate(tempData.message[0].cInfo.body, targetLang, function ( translatedText) {
						var translation = JSON.parse(translatedText);
						tempData.message[0].cInfo.body = translation.translation.translation;
						tempData.message[0].component.payload.text = translation.translation.translation;
	...
	function translate(userText, targetLang, callback)	{
	if (userText == null ) {
		return;
	}
	var url = "http://tcseia.eastus.cloudapp.azure.com:2999/translate?text="+userText+"&targetlang="+targetLang;
